// ngOnInit() {
  //   const olympicName: string = this.route.snapshot.params['name'];
  ...
  // this.subscriptionCountry = this.route.queryParamMap.subscribe(
    //   params => {
    //     const olympicCountry = params.get("country");

    //     if(olympicCountry) {
    //     this.country = olympicCountry
    //     }
    //   }
    // );
